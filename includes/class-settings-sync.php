...
class Settings_Sync {
	 ...
	 * for the periodic full-sync sweep done by RemoteManager::queue_sync_all_settings().
	 *
	 * @var string[]
	 */
	 ...
	 * so RemoteManager::queue_sync_all_settings() can resolve the local config value
