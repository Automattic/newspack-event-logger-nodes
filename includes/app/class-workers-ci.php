...
class Workers_CI extends Service_CI {
	 ...
	 *                            dump_metadata verb's live-position lookup). Production passes
	 *                            \Newspack_Event_Logger_Nodes\Memcached_Cache; tests pass FakeMemcached
	 *                            or an anon stub. Null disables the heartbeat verb and forces
	 *                            dump_metadata to fall back to on-disk offsetlog reads exclusively.
	 */
