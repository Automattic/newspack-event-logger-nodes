 ...
 *
 * The helper reads `message[VALUE].payload` directly — no parse step. The
 * source file is the synced copy of the canonical in newspack-nodes; this
 * test pins the same behavior application-side.
 */
