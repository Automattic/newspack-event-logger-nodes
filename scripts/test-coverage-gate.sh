...
<coverage><project>
  <file name="/services/pyrobase/sources/newspack-event-logger-nodes/includes/class-low.php">
    <class name="Newspack_Event_Logger_Nodes\Low"><metrics methods="2" coveredmethods="1"/></class>
    <line num="10" type="stmt" count="0"/>
    <line num="11" type="stmt" count="0"/>
    <line num="12" type="stmt" count="1"/>
    <line num="13" type="stmt" count="0"/>
  </file>
  <file name="/services/pyrobase/sources/newspack-event-logger-nodes/includes/class-high.php">
    <class name="Newspack_Event_Logger_Nodes\High"><metrics methods="1" coveredmethods="1"/></class>
    <line num="5" type="stmt" count="1"/>
    <line num="6" type="stmt" count="1"/>
  </file>
  <file name="/services/pyrobase/sources/newspack-event-logger-nodes/src/ignored.php">
