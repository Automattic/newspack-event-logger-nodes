...
**Code:** [`includes/class-log-manager.php`](../includes/class-log-manager.php) (:962-968): `HTTP_X_A8C_REQUEST_ID`, else `UNIQUE_ID`, else a generated id, capped at 64 bytes.
...
**Code:** [`includes/app/class-ask-assembler.php`](../includes/app/class-ask-assembler.php): `entry_shape()` (:373), `for_request()` (:85, the entry map at :96-99), `ENV_ALLOWLIST` (:76); [`includes/app/class-performance-ci-node.php`](../includes/app/class-performance-ci-node.php): `ask_request()` (:1311); [`includes/app/class-mcp-controller.php`](../includes/app/class-mcp-controller.php) (:136-141); [`src/overview/askBrief.js:186-188`](../src/overview/askBrief.js#L186-L188), the `entry:` case (:276) and `askClaudeUrl()` (:35).
